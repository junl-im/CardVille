...
1.0.27은 로비 배치 데이터, 건물별 콘텐츠 배정, 성능 품질 정책, CI 검증을 정리한 업데이트입니다. 1.0.26은 NPC 대화/말풍선/제스처 연결, 1.0.25는 건물/NPC/소품/UI/아이콘/캐릭터 프레임 확보와 자산 매니페스트 기반 업데이트였습니다.
