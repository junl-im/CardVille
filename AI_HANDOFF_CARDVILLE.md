...
1. 영어 학교 1차 수업 모드 또는 고양이 튜토리얼 시스템 추가
2. 사용자가 제작할 S급 디자인 에셋을 `assetManifest.ts`에 안전하게 연결
3. 상점 오퍼 수량을 늘리기 전 390×844 하단 버튼 겹침을 먼저 검수
3. 도서관 낱말 카드의 실패 복구 튜토리얼/힌트 연출을 더 확장
