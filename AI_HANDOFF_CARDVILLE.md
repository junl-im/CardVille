...
### 1.0.78 PlazaWalkNpcPolish / 자연스러운 대각선 보행 / NPC 오터치 분리
...
- 패치 기준: `CardVille_v1.0.78_RawOffscreenCanvasGuard_Full.zip`에 `CardVille_v1.0.78_PlazaWalkNpcPolish_DeltaPatch.zip`을 덮어쓰는 방식입니다.
- 산출물 이름: `CardVille_v1.0.78_PlazaWalkNpcPolish_Full.zip`, `CardVille_v1.0.78_PlazaWalkNpcPolish_DeltaPatch.zip`.

### 1.0.78 RawOffscreenCanvasGuard / 덮어쓰기용 작은 패치 정책 / canvas-only 인트로 보강

- 목적: 사용자가 지적한 “패치 파일이 통파일 같다” 문제를 해결하기 위해, v1.0.78도 직전 통파일 기준 변경 파일만 담는 Delta Patch를 산출합니다.
- 패치 기준: `CardVille_v1.0.76_DeltaPatchCanvasGuard_Full.zip`에 `CardVille_v1.0.78_RawOffscreenCanvasGuard_DeltaPatch.zip`을 그대로 덮어쓰는 방식입니다.
...
- 산출물 이름: `CardVille_v1.0.78_RawOffscreenCanvasGuard_Full.zip`, `CardVille_v1.0.78_RawOffscreenCanvasGuard_DeltaPatch.zip`.
- 검증 호환 앵커: CardVille_v1.0.75_CanvasIntroFloorPolish_Full.zip, CardVille_v1.0.78_DeltaPatchCanvasGuard_Full.zip, CardVille_v1.0.78_DeltaPatchCanvasGuard_DeltaPatch.zip.
- 이전 기록: 패치 ZIP이 통파일과 비슷한 용량인 이유는 v1.0.75까지 self-contained 패치가 public/assets 전체를 포함했기 때문입니다. v1.0.78부터 Delta Patch는 변경 없는 assets를 제외합니다.

- 검증 호환 앵커: IntroVideoHardVisible, IntroVideoMinFit, IntroNoOverlayPolish, IntroCleanSweep, LegacyGuardUIPolish, CanvasIntroFloorPolish, window.__CARDVILLE_INTRO_VIDEO_STARTED_AT__, MIN_INTRO_VIDEO_MS = 3000, input-watchdog-v166, 새 docs 문서 생성 금지, CardVille_v1.0.78_IntroVideoHardVisible_Full.zip, CardVille_v1.0.78_LegacyGuardUIPolish_Full.zip, CardVille_v1.0.78_IntroCleanSweep_Full.zip, CardVille_v1.0.78_IntroNoOverlayPolish_Full.zip.

### 1.0.78 CanvasIntroFloorPolish / native 영상 UI 우회 / 바닥 이동 hit guard 패스
...
- 산출물 이름: `CardVille_v1.0.78_CanvasIntroFloorPolish_Full.zip`, `CardVille_v1.0.78_CanvasIntroFloorPolish_Patch.zip`.


### 1.0.78 IntroMaskFloorMove / LegacyGuardUIPolish 호환 / 예전 코드 재발 방지 강화 패스
...
- 산출물 이름: `CardVille_v1.0.78_IntroMaskFloorMove_Full.zip`, `CardVille_v1.0.78_IntroMaskFloorMove_Patch.zip`.
- 이전 검증 호환 ZIP 앵커: CardVille_v1.0.78_LegacyGuardUIPolish_Full.zip, CardVille_v1.0.78_IntroCleanSweep_Full.zip, CardVille_v1.0.78_IntroCleanSweep_Patch.zip, CardVille_v1.0.78_IntroNoOverlayPolish_Full.zip, CardVille_v1.0.78_IntroGuardUIPolish_Full.zip, CardVille_v1.0.78_IntroVideoHardVisible_Full.zip.
...
- 추가 검증 호환 ZIP 앵커: CardVille_v1.0.78_IntroGuardUIPolish_Patch.zip, CardVille_v1.0.78_IntroVideoMinFit_Full.zip, CardVille_v1.0.78_CornerSweepStability_Full.zip, CardVille_v1.0.78_FlowFitUIPolish_Full.zip.
