...
include('public/build.json', ['"version": "1.0.78"', 'LegacyGuardUIPolish', 'intro-no-phaser-progress-v173', 'legacy-code-revival-guard-v173']);
include('public/health.html', ['version 1.0.78', 'LegacyGuardUIPolish', 'production-debug-overlay-kill-v173']);
include('README.md', ['# CardVille 1.0.78', '## 1.0.78 업데이트 내역', 'LegacyGuardUIPolish', 'CardVille_v1.0.78_LegacyGuardUIPolish_Full.zip']);
include('AI_HANDOFF_CARDVILLE.md', ['현재 기준 버전은 1.0.78', 'LegacyGuardUIPolish', 'legacy-code-revival-guard-v173', 'CardVille_v1.0.78_LegacyGuardUIPolish_Full.zip']);
