...
include('public/build.json', ['"version": "1.0.75"', 'IntroVideoHardVisible', 'intro-min-3s-video-v168']);
include('public/health.html', ['version 1.0.75', 'IntroVideoHardVisible', 'intro-min-3s-video-v168']);
include('README.md', ['# CardVille 1.0.75', '## 1.0.75 업데이트 내역', 'intro-min-3s-video-v168', 'CardVille_v1.0.75_IntroVideoHardVisible_Full.zip']);
