...
include('public/build.json', ['"version": "1.0.76"', 'IntroVideoHardVisible', 'intro-min-3s-video-v168']);
include('public/health.html', ['version 1.0.76', 'IntroVideoHardVisible', 'intro-min-3s-video-v168']);
include('README.md', ['# CardVille 1.0.76', '## 1.0.76 업데이트 내역', 'intro-min-3s-video-v168', 'CardVille_v1.0.76_IntroVideoHardVisible_Full.zip']);
include('AI_HANDOFF_CARDVILLE.md', ['현재 기준 버전은 1.0.76', 'IntroVideoHardVisible', 'MIN_INTRO_VIDEO_MS = 3000', '새 docs 문서 생성 금지']);
