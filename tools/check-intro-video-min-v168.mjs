...
include('public/build.json', ['"version": "1.0.71"', 'IntroVideoHardVisible', 'intro-min-3s-video-v168']);
include('public/health.html', ['version 1.0.71', 'IntroVideoHardVisible', 'intro-min-3s-video-v168']);
include('README.md', ['# CardVille 1.0.71', '## 1.0.71 업데이트 내역', 'intro-min-3s-video-v168', 'CardVille_v1.0.71_IntroVideoHardVisible_Full.zip']);
