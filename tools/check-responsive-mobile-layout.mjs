...
include('src/main.ts', '1.0.67 silent intro and exit/copy fit');
...
include('public/build.json', '1.0.67');
...
include('AI_HANDOFF_CARDVILLE.md', 'CardVille_v1.0.67_IntroExitCopyFit_Full.zip');
