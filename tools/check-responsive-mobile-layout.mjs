...
include('src/main.ts', '1.0.68 silent intro and exit/copy fit');
...
include('public/build.json', '1.0.68');
...
include('AI_HANDOFF_CARDVILLE.md', 'CardVille_v1.0.68_IntroVideoMinFit_Full.zip');
