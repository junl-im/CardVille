...
include('src/main.ts', '1.0.79 silent intro and exit/copy fit');
...
include('public/build.json', '1.0.79');
...
include('AI_HANDOFF_CARDVILLE.md', 'CardVille_v1.0.79_IntroGuardUIPolish_Full.zip');
