...
include('src/main.ts', '1.0.63 touch scale notice fix');
include('index.html', "window.__CARDVILLE_VERSION__ = '1.0.63'");
include('index.html', 'no generic loading copy on boot');
exclude('index.html', '시작 화면 준비가 지연돼요');
include('public/build.json', 'TouchScaleNoticeFix');
include('public/build.json', '1.0.63');
include('README.md', '## 1.0.63 업데이트 내역');
include('README.md', 'responsive-surface-spread-v163');
include('AI_HANDOFF_CARDVILLE.md', '현재 기준 버전은 1.0.63');
include('AI_HANDOFF_CARDVILLE.md', '스크린샷만 기준');
include('AI_HANDOFF_CARDVILLE.md', '패치 ZIP이 통파일과 비슷한 용량인 이유');
include('AI_HANDOFF_CARDVILLE.md', 'CardVille_v1.0.63_TouchScaleNotice_Full.zip');
