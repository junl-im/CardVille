...
include('public/build.json', ['"version": "1.0.80"', 'CanvasIntroFloorPolish', 'intro-canvas-video-surface-v176', 'floor-walk-hit-guard-v176']);
include('public/health.html', ['version 1.0.80', 'CanvasIntroFloorPolish', 'intro-canvas-video-surface-v176']);
include('README.md', ['# CardVille 1.0.80', '## 1.0.80 업데이트 내역', 'CanvasIntroFloorPolish', 'CardVille_v1.0.80_CanvasIntroFloorPolish_Full.zip']);
include('AI_HANDOFF_CARDVILLE.md', ['현재 기준 버전은 1.0.80', 'CanvasIntroFloorPolish', 'intro-canvas-video-surface-v176', 'floor-walk-hit-guard-v176']);
