...
const assert = (condition, message) => {
  if (!condition) {
    console.error(`[check-canvas-intro-floor-v176] ${message}`);
    process.exit(1);
  }
};
...
include('index.html', [
  ...
  'data-cardville-canvas-video-v176',
  'data-cardville-canvas-painted-v176',
...
include('public/build.json', ['"version": "1.0.79"', 'CanvasIntroFloorPolish', 'intro-canvas-video-surface-v176', 'floor-walk-hit-guard-v176']);
include('public/health.html', ['version 1.0.79', 'CanvasIntroFloorPolish', 'intro-canvas-video-surface-v176']);
include('README.md', ['# CardVille 1.0.79', '## 1.0.79 업데이트 내역', 'CanvasIntroFloorPolish', 'CardVille_v1.0.79_CanvasIntroFloorPolish_Full.zip']);
include('AI_HANDOFF_CARDVILLE.md', ['현재 기준 버전은 1.0.79', 'CanvasIntroFloorPolish', 'intro-canvas-video-surface-v176', 'floor-walk-hit-guard-v176']);
...
console.log('[check-canvas-intro-floor-v176] OK');
