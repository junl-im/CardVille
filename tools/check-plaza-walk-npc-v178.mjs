...
include('README.md', [
  'PlazaWalkNpcPolish',
  'CardVille_v1.0.80_RawOffscreenCanvasGuard_Full.zip',
  'CardVille_v1.0.80_PlazaWalkNpcPolish_DeltaPatch.zip',
  'public/assets` 전체는 포함하지 않습니다'
]);
include('AI_HANDOFF_CARDVILLE.md', [
  '1.0.80 PlazaWalkNpcPolish',
  'floor-walk-natural-pace-v178',
...
include('public/health.html', ['version 1.0.80', 'PlazaWalkNpcPolish', 'floor-walk-natural-pace-v178']);
