...
include('public/health.html', ['version 1.0.80', 'IntroVideoHardVisible']);
include('README.md', ['# CardVille 1.0.80', '## 1.0.80 업데이트 내역', 'intro-min-3s-video-v168', 'double-back-exit-v168']);
