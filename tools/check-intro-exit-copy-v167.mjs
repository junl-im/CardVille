...
include('public/health.html', ['version 1.0.79', 'IntroVideoHardVisible']);
include('README.md', ['# CardVille 1.0.79', '## 1.0.79 업데이트 내역', 'intro-min-3s-video-v168', 'double-back-exit-v168']);
