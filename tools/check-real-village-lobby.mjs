...
include('src/game/data/assetManifest.ts', "CARDVILLE_ASSET_VERSION = '1.0.80'");
...
include('src/game/scenes/IntroLoadingScene.ts', 'intro-no-phaser-progress-v173');
...
for (const token of ["key: 'npcMerchant', x: 24", "key: 'npcWizard', x: 366", "key: 'npcLibrarian', x: 24", "key: 'npcForestSagePremium', x: 24", "npc-clear-building-lane-v180"]) {
