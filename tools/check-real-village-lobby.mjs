...
include('src/game/data/assetManifest.ts', "CARDVILLE_ASSET_VERSION = '1.0.62'");
...
include('src/game/scenes/MainLobbyScene.ts', 'responsive-mobile-viewport-v162');
...
include('AI_HANDOFF_CARDVILLE.md', '1.0.62 실제 모바일 반응형 viewport');
