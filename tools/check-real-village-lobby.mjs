...
include('src/game/data/assetManifest.ts', "CARDVILLE_ASSET_VERSION = '1.0.79'");
...
for (const token of ["key: 'npcMerchant', x: 132", "key: 'npcWizard', x: 254", "key: 'npcLibrarian', x: 128", "key: 'npcForestSagePremium', x: 128"]) {
