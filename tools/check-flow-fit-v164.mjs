...
include('README.md', 'CardVille_v1.0.70_IntroGuardUIPolish_Full.zip');
...
console.log('check:flow-fit v1.0.70 passed: silent transitions, text fit, line-soft surfaces, and scale tween dedupe verified.');
