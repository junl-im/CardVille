...
include('README.md', '## 1.0.75 업데이트 내역');
include('README.md', 'CardVille_v1.0.75_IntroGuardUIPolish_Full.zip');
include('AI_HANDOFF_CARDVILLE.md', '현재 기준 버전은 1.0.75');
include('AI_HANDOFF_CARDVILLE.md', '1.0.65 전역 UI 흐름/텍스트/전환 안정화 패스');
include('public/build.json', 'IntroVideoMinFit');
include('index.html', "window.__CARDVILLE_VERSION__ = '1.0.75'");

console.log('check:flow-fit v1.0.75 passed: silent transitions, text fit, line-soft surfaces, and scale tween dedupe verified.');
