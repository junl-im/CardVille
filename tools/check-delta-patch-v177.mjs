...
include('README.md', [
  ...
  'CardVille_v1.0.79_RawOffscreenCanvasGuard_DeltaPatch.zip',
...
include('index.html', ["cardvilleIntroSrc(){ return new URL('./assets/video/cardville_intro_loading.mp4?v=1.0.79'", 'raw-video-offscreen-v177']);
