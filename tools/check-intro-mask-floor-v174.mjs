...
include('index.html', [
  ...
  "cardville_intro_loading.mp4?v=1.0.76",
...
include('public/build.json', ['"version": "1.0.76"', 'IntroMaskFloorMove', 'intro-native-control-mask-v174']);
include('public/health.html', ['version 1.0.76', 'IntroMaskFloorMove', 'intro-native-control-mask-v174']);
include('README.md', ['# CardVille 1.0.76', '## 1.0.76 업데이트 내역', 'IntroMaskFloorMove', 'CardVille_v1.0.76_IntroMaskFloorMove_Full.zip']);
include('AI_HANDOFF_CARDVILLE.md', ['현재 기준 버전은 1.0.76', 'IntroMaskFloorMove', 'intro-native-control-mask-v174', 'free-plaza-floor-walk-v174']);
