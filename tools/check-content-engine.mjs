...
must('src/game/scenes/ModeSelectScene.ts', ['startMode(mode', "mode.routeScene === 'MathLabScene'", "mode.routeScene === 'MemoryForestScene'", "NavigationSystem.safeStart(this, 'StageSelectScene'"]);
must('src/game/scenes/StageSelectScene.ts', ['MATH_STAGES', 'MEMORY_STAGES', "NavigationSystem.safeStart(this, stage.routeScene", 'drawProgressStrip']);
