...
include('public/build.json', ['"version": "1.0.80"', 'IntroCleanSweep', 'intro-preplay-shield-v172', 'legacy-loading-code-quarantine-v172']);
include('public/health.html', ['version 1.0.80', 'IntroCleanSweep', 'intro-preplay-shield-v172', 'intro-no-progress-surface-v172']);
include('README.md', ['# CardVille 1.0.80', '## 1.0.80 업데이트 내역', 'IntroCleanSweep', 'CardVille_v1.0.80_IntroCleanSweep_Full.zip']);
include('AI_HANDOFF_CARDVILLE.md', ['현재 기준 버전은 1.0.80', 'IntroCleanSweep', 'legacy-loading-code-quarantine-v172', 'CardVille_v1.0.80_IntroCleanSweep_Full.zip']);
