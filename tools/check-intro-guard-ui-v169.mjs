...
include('public/health.html', ['version 1.0.72', 'IntroVideoHardVisible', 'intro-started-at-zero-guard-v169']);
include('README.md', ['# CardVille 1.0.72', '## 1.0.72 업데이트 내역', 'intro-hard-visible-v170', 'CardVille_v1.0.72_IntroVideoHardVisible_Full.zip']);
include('AI_HANDOFF_CARDVILLE.md', ['현재 기준 버전은 1.0.72', 'IntroVideoHardVisible', 'window.__CARDVILLE_INTRO_VIDEO_STARTED_AT__', 'CardVille_v1.0.72_IntroVideoHardVisible_Full.zip']);
