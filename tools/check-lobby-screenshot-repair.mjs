...
assert(pkg.version === '1.0.62', `package version expected 1.0.62, got ${pkg.version}`);

mustInclude('src/game/data/assetManifest.ts', "CARDVILLE_ASSET_VERSION = '1.0.62'");
...
mustInclude('README.md', '1.0.62 업데이트 내역');
...
mustInclude('AI_HANDOFF_CARDVILLE.md', '현재 기준 버전은 1.0.62');
...
mustInclude('index.html', "window.__CARDVILLE_VERSION__ = '1.0.62'");
