...
assert(pkg.version === '1.0.67', `package version expected 1.0.67, got ${pkg.version}`);

mustInclude('src/game/data/assetManifest.ts', "CARDVILLE_ASSET_VERSION = '1.0.67'");
...
mustInclude('AI_HANDOFF_CARDVILLE.md', '현재 기준 버전은 1.0.67');
mustInclude('AI_HANDOFF_CARDVILLE.md', '1.0.59 로비 이미지 강제 로딩/스크린샷 기반 배치 핫픽스');
mustInclude('public/build.json', 'IntroExitCopyFit');
mustInclude('index.html', "window.__CARDVILLE_VERSION__ = '1.0.67'");
