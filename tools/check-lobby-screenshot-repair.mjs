...
assert(pkg.version === '1.0.79', `package version expected 1.0.79, got ${pkg.version}`);

mustInclude('src/game/data/assetManifest.ts', "CARDVILLE_ASSET_VERSION = '1.0.79'");
