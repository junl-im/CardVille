...
assert(pkg.version === '1.0.78', `package version expected 1.0.78, got ${pkg.version}`);

mustInclude('src/game/data/assetManifest.ts', "CARDVILLE_ASSET_VERSION = '1.0.78'");
