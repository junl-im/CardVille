...
include('index.html', [
  ...
  "new URL('./assets/video/cardville_intro_poster.jpg?v=1.0.79', document.baseURI).href",
...
include('public/build.json', ['"version": "1.0.79"', 'IntroNoOverlayPolish', 'intro-no-native-video-ui-v171', 'intro-no-loading-surface-v171']);
include('public/health.html', ['version 1.0.79', 'IntroNoOverlayPolish', 'intro-no-native-video-ui-v171', 'intro-playmark-shield-v171']);
include('README.md', ['# CardVille 1.0.79', '## 1.0.79 업데이트 내역', 'IntroNoOverlayPolish', 'CardVille_v1.0.79_IntroNoOverlayPolish_Full.zip']);
include('AI_HANDOFF_CARDVILLE.md', ['현재 기준 버전은 1.0.79', 'IntroNoOverlayPolish', 'intro-no-native-video-ui-v171', 'CardVille_v1.0.79_IntroNoOverlayPolish_Full.zip']);
