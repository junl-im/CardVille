...
for (const token of ['1.0.53', 'screen-ui-stability-pass-v152', 'scene-navigation-guard-v152', 'route ribbon must not overlap', 'mobile-readable-layout-v153', 'village-edge-spacing-v153']) {
...
for (const token of ['CARDVILLE_MOBILE_TEXT_TAG', 'mobile-readable-text-v153', 'readableSize', 'mobileTextScale', 'minReadable']) {
