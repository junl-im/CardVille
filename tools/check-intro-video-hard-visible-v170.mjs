...
include('public/health.html', ['version 1.0.72', 'IntroVideoHardVisible', 'intro-hard-visible-v170']);
include('AI_HANDOFF_CARDVILLE.md', ['현재 기준 버전은 1.0.72', 'IntroVideoHardVisible', 'intro-hard-visible-v170', 'CardVille_v1.0.72_IntroVideoHardVisible_Full.zip']);
include('README.md', ['# CardVille 1.0.72', '## 1.0.72 업데이트 내역', 'IntroVideoHardVisible']);

console.log('Intro video hard-visible v1.0.72 check passed: video-only startup, 3s guard, copy fit, nameplate/settings UI sweep verified.');
