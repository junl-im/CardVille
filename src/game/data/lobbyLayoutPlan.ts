export const LOBBY_LAYOUT_PLAN_VERSION = '1.0.48' as const;
...
export const LOBBY_PREMIUM_VISUAL_FIT_AUDIT = [
  ...
  '1.0.48 renders those square assets with fitImageToBox instead of setDisplaySize(width,height) stretch',
...
export const LOBBY_VISIBLE_ASSET_ROUTE_AUDIT = [
  '1.0.48 keeps premium lobby assets self-contained in patch ZIPs',
