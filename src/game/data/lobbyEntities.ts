...
export const LOBBY_PROPS: readonly LobbyProp[] = [
  ...
  { key: 'propBench', x: 28, y: 606, width: 56, height: 32, depth: 606 },
  { key: 'propBench', x: 362, y: 606, width: 56, height: 32, depth: 606 },
...
export const LOBBY_NPCS: readonly LobbyNpc[] = [
  ...
  {
    key: 'npcLibrarian', x: 104, y: 378, width: 36, height: 50, label: '사서', delay: 100, animation: 'book',
    lines: ['도서관에는 낱말 카드가 가득해요. 오늘은 단어를 모아 볼까요?', '책장이 반짝이면 새 단어 카드가 숨어 있다는 뜻이에요.']
  },
  {
    key: 'npcWizard', x: 286, y: 378, width: 36, height: 50, label: '마법사', delay: 200, animation: 'sparkle',
    lines: ['연구소의 숫자 마법은 곧 더 강해질 거예요.', '반짝이는 카드는 보너스 보상을 부르는 신호랍니다.']
  },
  {
    key: 'npcMerchant', x: 104, y: 584, width: 42, height: 62, label: '상인', delay: 300, animation: 'wave',
    lines: ['수집한 카드는 앨범에서 바로 확인할 수 있어요!', '새 카드팩이 들어오면 이벤트 광장에 먼저 놓아둘게요.']
  },
  {
    key: 'npcTeacher', x: 286, y: 584, width: 38, height: 52, label: '선생님', delay: 400, animation: 'teach',
    lines: ['학교는 영어 카드 수업을 준비 중이에요.', '카드마을 수업은 문제풀이보다 모험처럼 느껴져야 해요.']
  },
  {
    key: 'npcTownCat', x: 28, y: 730, width: 48, height: 48, label: '마을고양이', delay: 500, animation: 'cat',
    lines: ['야옹! 기억의 숲에는 짝을 찾는 카드가 숨어 있어요.', '검은 고양이를 따라가면 힌트를 놓치지 않을 거예요.']
  },
  {
    key: 'npcCook', x: 242, y: 730, width: 34, height: 48, label: '요리사', delay: 600, animation: 'cook',
    lines: ['이벤트 광장에는 오늘의 보상 냄새가 솔솔 나요!', '카드팩을 열 때는 반짝임을 꼭 확인하세요.']
  },
  {
    key: 'npcChild01', x: 225, y: 454, width: 31, height: 44, label: '아이', delay: 700, animation: 'child',
