...
console.info('[CardVille] Phaser instance created 1.0.43 mission reward popup accessibility UX / 1.0.42 streak weekly mission loop / 1.0.41 daily mission attendance loop / 1.0.40 no-asset cat coach guide / 1.0.39 ci build guard / 1.0.38 english school first class / 1.0.37 content scale reward UX / 1.0.36 shop offer cooldown UX / word combo recovery coach / backconfirm scene cleanup / start-ui polish / shop economy hub / content engine / quality audit engine / polish audit engine', game.isBooted);
